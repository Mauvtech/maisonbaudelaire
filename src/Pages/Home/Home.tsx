...
export function Home() {
    ...
    return (
        <div className="relative max-w-full max-h-screen bg-purple-500 sm:mt-0 min-h-screen w-screen overflow-hidden  flex justify-center items-center">
            {/* Conteneur principal pour aligner les éléments */}
            <div className="relative w-full h-full bg-green-500 max-h-screen sm:-mt-[10%] overflow-hidden flex items-center justify-center">
