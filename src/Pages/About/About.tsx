...
export function About() {
    return (
        <div className="xl:h-screen overflow-scroll">
            <main
                className="mx-auto flex 2xl:mt-0 xl:mt-[5%] md:w-[80%]  xl:flex-row mt-[10%] flex-col justify-between items-center px-8">
                <div
                    className="xl:w-1/2 w-full gap-[2%] flex flex-col justify-center items-center lg:items-start h-full py-4">
                    ...
                    <div className={"w-full flex justify-center"}>
                        <p className="lg:mt-8 mt-2 font-bold text-lg lg:text-2xl mb-6 lg:mb-0"> MAISON BAUDELAIRE</p>
                    </div>
